...
window.AVAD_I18N = {
  ...
  ar: {
    ...
    hero: {
      ...
      h1c: " في الإنتاج.",
      lede:
        "نبني في أفاد وكلاء ذكاء اصطناعي يمكن تشغيلها في الإنتاج، ونبني الفِرق التي تشغّلها، وننشر الأدوات المفتوحة التي يعتمد عليها المجال. استقلال عن المزوّد بحكم العقد.",
      cta1: "احجز مكالمة تأطير لمدة 30 دقيقة",
      cta2: "اقرأ منهجية التقييم",
      meta1: "أول مُخرَج عملي خلال الأسبوع الأول.",
      meta2: "أول وكيل يعمل بحلول الأسبوع الرابع.",
      meta3: "إلمام عملي بـ EU AI Act ونظام حماية البيانات السعودي."
    },
    artifact: {
      title: "evals/trajectory_suite",
    ...
    proof: {
      head: "ما نُسلّمه في أفاد افتراضيًا",
      strip: [
    ...
    problem: {
      ...
      sub: "خلاصة لأكثر من 30 مكالمة تأطير خلال 2025–2026 مع رؤساء الذكاء الاصطناعي ومديري التقنية والعمليات.",
      quotes: [
        {
    ...
    services: {
      ...
      list: [
        ...
        },
        {
          ...
          promise:
            "نُقيّم نظامك القائم وفق أوضاع فشل حقيقية، ونُسلّم حزمة التقييم التي كان يجب أن تُسلّم معه.",
          tag: "تجربة فاشلة",
          tags: ["تجربة فاشلة"],
          scope: [
        ...
        },
        {
          ...
          scope: [
            ...
            "خط أساس للتكلفة والكمون والدقة عبر مزوّدَين على الأقل، مع خيارات نماذج سيادية إقليمية في الاتحاد الأوروبي والخليج حيث تلائم الحالة."
          ],
        ...
        },
        {
          ...
          promise:
            "الإحاطة التقنية التي يحتاجها رئيسك التنفيذي والمجلس فعلًا: أين يحرّك الذكاء الاصطناعي الأرباح، وأين لا يحرّكها، وكيف يجب أن تبدو الأشهر الـ 12 المقبلة.",
          tag: "عرض مجلس",
          tags: ["عرض مجلس"],
          scope: [
    ...
    process: {
      ...
      sub: "ينتهي كل ارتباط بالمخرجات التي يحتاجها فريقك لتشغيل النظام دوننا في المسار الحرج.",
      steps: [
        {
          num: "الخطوة 01",
          when: "الأسبوع الأول",
        ...
        },
        {
          ...
          items: [
            ...
            "عرض أسبوعي على حركة تشبه الإنتاج"
          ]
        },
        {
          num: "الخطوة 03",
      ...
      cards: [
        {
          ...
          p:
            "ينتهي كل ارتباط بحزمة تقييم مودعة في مستودعك: تغطية على مستوى المسار، تصنيف لأوضاع الفشل، تكامل مع CI، وميزانية انحدار. لا شريحة عرض.",
          rubric: {
            label: "تغطية المسارات في آخر 6 ارتباطات",
            v: "وسيط 91%",
            pct: 91
          }
        },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "هذا هو المقصود. كل نظام نُسلّمه مُصمَّم للتبديل. نوثّق العقد، ونُشغّل اختبارات الانحدار على النموذج الجديد، ونحدّث خط الأساس. تبديل النموذج ضمن الارتباط مشمول في النطاق."
        },
        {
          q: "كيف تقيسون موثوقية الوكيل؟",
          a: "تقييم على مستوى المسار، لا المخرج النهائي فقط. نرسم خريطة أوضاع الفشل الخاصة بك من حركة حقيقية، ونحدّد ميزانية انحدار، ونربط النشر بها. المنهجية وأهداف التغطية منشورة لكل ارتباط."
        },
        {
          q: "ما السرعة المتوقعة؟",
          a: "أول مُخرَج عملي خلال الأسبوع الأول (تأطير، خريطة فشل، تصميم تقييم). أول وكيل يعمل أو إعادة هيكلة بحلول الأسبوع الرابع. تُسلَّم معظم الارتباطات خلال 6 إلى 12 أسبوعًا. لا نُسوّق بـ«إنتاج خلال 30 يومًا» لأن هذه المهلة هي ما أنتج التجارب الفاشلة."
        },
        {
          q: "من هو الفريق؟",
        ...
        },
        {
          ...
          a: "كلاهما، في كل ارتباط. نقل القدرات مشمول افتراضيًا. إن أردتم بناءً دون نقل قدرات، يمكن استثناؤه؛ العقد الافتراضي يفترض أننا نغادر، وتنتقل ملكية التقييم وكتيّب التراجع والاستجابة للحوادث إلى مهندسيكم."
        },
        {
    ...
    finalCta: {
      ...
      p:
        "مكالمة تأطير لمدة 30 دقيقة. لا حاجة لعرض. سنخبرك إن كان هذا ارتباط أفاد أم شيء يجب أن تُبقيه داخليًا.",
      ...
      formCard: {
        ...
        rows: [
          ...
          { k: "ستخرج بـ", v: "رأي مكتوب في ملاءمة الارتباط" }
        ]
      }
    },
    footer: {
