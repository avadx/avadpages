...
window.AVAD_I18N = {
  ...
  ar: {
    ...
    hero: {
      eyebrow: "شركة هندسية · محايدة تجاه النموذج بحكم العقد",
      h1a: "وكلاء ذكاء اصطناعي ",
      h1b: "تصمد",
      h1c: " في الإنتاج.",
      lede:
        "تبني avad.ai وكلاء ذكاء اصطناعي يمكن تشغيلها في الإنتاج، وتبني الفِرق التي تشغّلها، وتنشر الأدوات المفتوحة التي يعتمد عليها المجال. محايدة تجاه النموذج بحكم العقد.",
      cta1: "احجز مكالمة استكشافية لمدة 30 دقيقة",
      cta2: "اقرأ منهجيتنا في التقييم",
      meta1: "أول مُخرَج عملي خلال الأسبوع الأول.",
      meta2: "أول وكيل يعمل بحلول الأسبوع الرابع.",
      meta3: "إلمام عملي بـ EU AI Act وPDPL السعودي."
    },
    artifact: {
      title: "evals/trajectory_suite",
      ...
      rows: [
        ...
        { name: "trajectory.escalation_handoff", num: "61/63", state: "fail", label: "فشل 2" },
    ...
    proof: {
      head: "ما تُسلّمه avad.ai افتراضيًا",
      strip: [
    ...
    services: {
      ...
      sub: "اختر الموقف الذي أنت فيه. كل بطاقة تفتح على النطاق والمشتري المثالي وهيكل المهمة.",
      chips: [
        "الكل",
        "تجربة فاشلة",
        "ضغط التجديد",
      ...
      list: [
        {
          ...
          shape:
            "من 8 إلى 12 أسبوعًا. نطاق ثابت ومعايير نجاح مكتوبة. مهندس أول واحد مسؤول."
        },
        {
          num: "02 / تدقيق",
          h: "تدقيق وإعادة بناء حزمة التقييم",
          promise:
            "نُقيّم نظامك القائم وفق أنماط فشل حقيقية، ونُسلّم حزمة التقييم التي كان يجب أن تُسلّم معه.",
          tag: "تجربة فاشلة",
          tags: ["تجربة فاشلة"],
          scope: [
        ...
        },
        {
          ...
          h: "بناء قدرات مدمجة",
          promise:
            "يتعلم فريقك إطلاق أنظمة الذكاء الاصطناعي وتشغيلها في الإنتاج. عند التسليم، تنتقل ملكية تشغيل النظام إلى مهندسيك.",
          tag: "بناء فريق",
          tags: ["بناء فريق"],
          scope: [
          ...
          shape:
            "من 8 إلى 16 أسبوعًا. دليل عمل موثّق ومقياس لقدرات الفريق، بدرجات قبل/أثناء/بعد."
        },
        {
          num: "04 / امتثال",
          ...
          tags: ["نافذة إلزام"],
          scope: [
            "تصنيف Annex III للأنظمة المعنية، وتصنيف PDPL لأحمال العمل داخل المملكة، مع طبقة قطاعية عند الحاجة.",
          ...
          shape:
            "من 6 إلى 10 أسابيع. حزمة امتثال وبنية مُعالَجة وخطة سد الفجوات."
        },
        {
          num: "05 / بنية",
        ...
        },
        {
          ...
          promise:
            "الإحاطة التقنية التي يحتاجها رئيسك التنفيذي والمجلس فعلًا: أين يحرّك الذكاء الاصطناعي الأرباح والخسائر، وأين لا يحرّكها، وكيف يجب أن تبدو الأشهر الـ 12 المقبلة.",
          tag: "عرض مجلس",
          tags: ["عرض مجلس"],
          scope: [
      ...
      steps: [
        ...
        },
        {
          ...
          items: [
            ...
            "دليل التراجع",
            "وثائق الاستدعاء",
            "أدلة المطابقة (EU AI Act وPDPL والجهات التنظيمية القطاعية)"
          ]
        },
        {
          num: "الخطوة 04",
    ...
    why: {
      ...
      sub: "إن لم نستطع قياسه، لا نُسلّمه. لكل من النقاط الثلاث مُخرَج منشور.",
      cards: [
        {
          h: "حزمة التقييم تُسلَّم مع الوكيل",
          p:
            "تنتهي كل مهمة بحزمة تقييم مودعة في مستودعك: تغطية على مستوى المسار، تصنيف لأنماط الفشل، تكامل مع CI، وميزانية انحدار. لا شريحة عرض.",
          rubric: {
            label: "تغطية المسارات في آخر 6 مهام",
            v: "وسيط 91%",
            pct: 91
          }
        },
        {
          ...
          p:
            "نُصمم على طبقة البروتوكول (MCP وA2A) قبل اختيار النموذج. كل مهمة تتضمن خطة تبديل موثّقة وخط أساس مُقاس عبر مزوّدَين على الأقل.",
          rubric: {
      ...
      cards: [
        ...
        },
        {
          ...
          items: [
            ...
            "متوافق افتراضيًا مع PDPL لأحمال العمل داخل المملكة، مع توثيق شروط نقل البيانات لدى سدايا.",
            "اتفاقيات DPA وBAA موقّعة عند الحاجة.",
            "لا ندرّب أي نماذج على بيانات العميل. تنص العقود على ذلك صراحةً."
          ]
        },
        {
          h: "الكفاءة التنظيمية",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "هذا هو المقصود. كل نظام نُسلّمه مُصمَّم للتبديل. نوثّق العقد، ونُشغّل اختبارات الانحدار على النموذج الجديد، ونحدّث خط الأساس. تبديل النموذج ضمن المهمة مشمول في النطاق."
        },
        {
        ...
        {
          q: "من هو الفريق؟",
          a: "مهندسون كبار وباحثون فقط. الشخص الذي يُحدّد نطاق المهمة هو الشخص المناوب عند الإطلاق. لا تُنفَّذ مهمة بأقل من مهندسَين كبيرَين."
        },
        {
          q: "هل تدرّبون فريقنا أم تبنون لنا فقط؟",
          a: "كلاهما، في كل مهمة. نقل القدرات مشمول افتراضيًا. إن أردتم بناءً دون نقل قدرات، يمكن استثناؤه؛ العقد الافتراضي يفترض أننا نغادر، وتنتقل ملكية التقييم ودليل التراجع والاستجابة للحوادث إلى مهندسيكم."
        },
        {
          q: "لماذا تنشرون أدوات مفتوحة؟ هل ملكيتنا الفكرية آمنة في مستودعنا؟",
    ...
    finalCta: {
      ...
      h2: "أحضر نمط الفشل والموعد النهائي.",
      p:
        "مكالمة استكشافية مدتها 30 دقيقة. لا حاجة لعرض. سنخبرك إن كانت هذه مهمة لـ avad.ai أم شيئًا يجب أن تُبقيه داخليًا.",
    ...
    footer: {
      blurb:
        "شركة هندسية تبني وكلاء ذكاء اصطناعي تصمد أمام تقييماتك وبياناتك ومدققيك. الرياض · فرانكفورت · عن بُعد.",
      groups: [
        {
          h: "المهام",
          links: [
